...
import shardeum from "../../assets/images/events/shardeum.png";
        ...
        <div className="row">
          ...
          >
            <div className="text-center">
              <img src={shardeum} alt="Rlogo" width="60%" />
            </div>
            <h1 className="display-3">Proof of Community</h1>
            <hr className="my-2" />
            <p className="text-center">
              This event focused on mastering all things web3 master everything
              starting from creating your first DAO to building smart contracts.
            </p>
            <div className="row">
              <div className="mx-auto col-6">
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://drive.google.com/drive/folders/1trAYN8qFFmFFhjn-i8M9uDCBgpgfcB2a"
                    )
                  }
                >
                  Certificates
          ...
          >
            ...
            <hr className="my-2" />
            <p className="text-center">
              A comprehensive hackathon that focused on analyzing the
              participant's technical & problem-solving skills in a competitive
              environment and also the amazing projects.
            </p>
            <div className="row">
              <div className="mx-auto col-6">
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://drive.google.com/drive/folders/1G1pkDjrlphGvTnbCti8brDzlNHMnMgR-"
                    )
                  }
                >
                  Certificates
              ...
              <div className="mx-auto col-6">
                <Button
                  ...
                  onClick={() =>
                    window.open(
                      "https://drive.google.com/drive/folders/1Wf4GO0TsMEbJDt31p9j0a16YFNWw7fC_?usp=sharing"
                    )
                  }
                >
                  Gallery
          ...
          >
            ...
            <hr className="my-2" />
            <p className="text-center">
              To acquaint you with the phenomenal concept of Deep Learning, we
              bring to you a week-long bootcamp ‘NeuRes’, wherein we have a
              series of insightful workshops exploring the topic.
            </p>
            <div className="row">
              <div className="mx-auto col-6">
                <Button className={classes.certBTN + " col-12"}>
                  Certificates
                </Button>
              </div>
              <div className="mx-auto col-6">
                <Button className={classes.galleryBTN + " col-12"}>
                  Gallery
                </Button>
              </div>
            </div>
